...
"""
    ...
    def generate_response(self, query: str,
        ...
        if tools and tool_manager and max_rounds > 1:
            return self._execute_sequential_rounds(query, system_content, tools, tool_manager, max_rounds)
    ...
    def _execute_single_round(self, query: str, system_content: str, tools: Optional[List], tool_manager) -> str:
        """
    ...
    def _execute_sequential_rounds(self, query: str, system_content: str, tools: List, tool_manager, max_rounds: int) -> str:
        """
