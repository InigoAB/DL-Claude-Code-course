...
class TestRAGSystem:
    ...
    def test_query_successful_without_session(self, test_config, mock_components):
        ...
        mock_components['ai_generator'].generate_response.return_value = "Generated response"
    ...
    def test_query_successful_with_session(self, test_config, mock_components):
        ...
        mock_components['ai_generator'].generate_response.return_value = "Response with context"
        ...
        mock_components['session_manager'].get_conversation_history.assert_called_once_with("test-session")
    ...
    def test_query_with_sources(self, test_config, mock_components):
        ...
        mock_components['ai_generator'].generate_response.return_value = "Answer with sources"
        mock_sources = [
    ...
    def test_query_ai_generator_error(self, test_config, mock_components):
        ...
        mock_components['ai_generator'].generate_response.side_effect = Exception("API Error")
    ...
    def test_add_course_document_successful(self, test_config, mock_components, sample_course, sample_course_chunks):
        ...
        mock_components['doc_processor'].process_course_document.assert_called_once_with("/path/to/course.txt")
    ...
    def test_add_course_document_processing_error(self, test_config, mock_components):
        ...
        mock_components['doc_processor'].process_course_document.side_effect = Exception("Processing failed")
    ...
    @patch('rag_system.os.path.exists')
    def test_add_course_folder_nonexistent(self, mock_exists, test_config, mock_components):
    ...
    @patch('rag_system.os.path.exists')
    @patch('rag_system.os.listdir')
    def test_add_course_folder_clear_existing(self, mock_listdir, mock_exists, test_config, mock_components, sample_course, sample_course_chunks):
    ...
    def test_session_management_flow(self, test_config, mock_components):
        ...
        mock_components['ai_generator'].generate_response.return_value = "Session response"
        mock_components['session_manager'].get_conversation_history.return_value = "Previous context"
        ...
        mock_components['session_manager'].get_conversation_history.assert_called_once_with(session_id)
    ...
    def test_tool_manager_integration(self, test_config, mock_components):
        ...
        rag.tool_manager.get_tool_definitions = Mock(return_value=[{'name': 'test_tool'}])
        rag.tool_manager.get_last_sources = Mock(return_value=[])
        rag.tool_manager.reset_sources = Mock()
...
class TestRAGSystemRealIntegration:
    ...
    def test_missing_api_key_behavior(self):
        ...
        with patch('rag_system.AIGenerator') as mock_ai_gen:
            ...
            mock_ai_instance.generate_response.side_effect = Exception("Invalid API key")
