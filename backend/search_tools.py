...
class CourseOutlineTool(Tool):
    ...
    def _find_matching_course(self, query_title: str, courses: List[Dict]) -> Optional[Dict]:
    ...
    def _format_course_outline(self, course: Dict) -> str:
        ...
        if (course_link and 
            course_link.strip() and 
            course_link not in ['No link available', 'None', 'null'] and
            course_link.startswith('http')):
        ...
        try:
            ...
            if (course_link and 
                ...
                print(f"DEBUG CourseOutlineTool - Course link failed condition check: '{course_link}'")
        except Exception as e:
    ...
    def get_last_sources(self) -> list:
        ...
        for tool_name, tool in self.tools.items():
            if hasattr(tool, 'last_sources') and tool.last_sources:
                print(f"DEBUG ToolManager - Found sources from {tool_name}: {tool.last_sources}")
